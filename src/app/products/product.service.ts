...
export class ProductService {
  ...
  .pipe(
    ...
    productsWithCategory$=combineLatest([
      this.products$,this.productCategoryService.productCategory$
    ]).pipe(
    ...
    selectedProduct$=combineLatest([
      ...
      map(([products,selectedProductId])=>
        products.find(
          ...
          product=>console.log("selectedProduct",product)
        ),shareReplay(1)
    );
    selectedProdectChanged(selectedProductId:number):void{
